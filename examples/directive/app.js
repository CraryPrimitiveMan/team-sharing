define(['routes', 'loader', 'angular', 'angular-route', 'angular-resource', 'angular-bootstrap'], function (config, loader) {
    'use strict';

    var app = angular.module('hrm', ['ngRoute', 'ngResource', 'ui.bootstrap']);
